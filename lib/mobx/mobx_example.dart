...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final taskStoreMobx = Provider.of<TaskStoreMobx>(context, listen: false);
    return Scaffold(
                ...
                child: Observer(
                  builder: (context) {
                    return ListView.builder(
                      itemCount: taskStoreMobx.tasks.length,
                      itemBuilder: (context, index) {
                        print(taskStoreMobx.tasks[index].title);
                        return Container(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              taskStoreMobx.tasks[index].title,
                              style: const TextStyle(
                            ...
                            subtitle: Text(
                              taskStoreMobx.tasks[index].detail,
                              style: const TextStyle(
